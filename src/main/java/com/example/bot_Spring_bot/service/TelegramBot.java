package com.example.bot_Spring_bot.service;

import com.example.bot_Spring_bot.config.BotConfig;
import com.example.bot_Spring_bot.model.User;
import com.example.bot_Spring_bot.model.UserRepository;
...
public class TelegramBot extends TelegramLongPollingBot {
    ...
    private void startCommandReceived(long chatId, String name) {
        String answer = EmojiParser.parseToUnicode("Hi, " + name + ", nice to meet u!" + " :blush:");
